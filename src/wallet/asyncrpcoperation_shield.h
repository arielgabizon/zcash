...
#ifndef ASYNCRPCOPERATION_SHIELD_H
#define ASYNCRPCOPERATION_SHIELD_H
...
public:
    ...
    AsyncRPCOperation_shield(AsyncRPCOperation_shield const&) = delete;             // Copy construct
    AsyncRPCOperation_shield(AsyncRPCOperation_shield&&) = delete;                  // Move construct
    AsyncRPCOperation_shield& operator=(AsyncRPCOperation_shield const&) = delete;  // Copy assign
    AsyncRPCOperation_shield& operator=(AsyncRPCOperation_shield &&) = delete;      // Move assign
...
private:
    friend class TEST_FRIEND_AsyncRPCOperation_shield;    // class for unit testing
...
class TEST_FRIEND_AsyncRPCOperation_shield {
public:
    std::shared_ptr<AsyncRPCOperation_shield> delegate;
    
    TEST_FRIEND_AsyncRPCOperation_shield(std::shared_ptr<AsyncRPCOperation_shield> ptr) : delegate(ptr) {}
...
#endif /* ASYNCRPCOPERATION_SHIELD_H */
